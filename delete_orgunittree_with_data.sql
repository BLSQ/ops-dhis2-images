-- stolen from https://raw.githubusercontent.com/dhis2/dhis2-utils/refs/heads/master/resources/sql/delete_orgunittree_with_data.sql
...
-- no more present in 2.40 EXECUTE 'DELETE FROM organisationunitattributevalues WHERE organisationunitid = $1 ' USING organisationunitid;
...
EXECUTE 'DELETE FROM trackedentityprogramowner WHERE trackedentityinstanceid IN(SELECT trackedentityinstanceid from trackedentityinstance where organisationunitid = $1) ' USING organisationunitid;
